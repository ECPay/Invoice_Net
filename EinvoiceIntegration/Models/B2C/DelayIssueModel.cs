...
{
    public class DelayIssueModel : BaseModel
    {
        public class Item
        {
            /// <summary>
        ...
        private DelayFlagEnum delayFlagEnum;

        [JsonIgnore]
        public DelayFlagEnum DelayFlagEnum
        {
            get { return delayFlagEnum; }
            set { delayFlagEnum = value; }
        }
        ...
        [Required]
        [Display(Name = "交易類別")]
        [RegularExpression("^[2]{1}$")]
        public string PayType { get; set; }

        [Required]
        [Display(Name = "交易類別名稱")]
        [RegularExpression("^[ECPAY]{5}$")]
        public string PayAct { get; set; }
