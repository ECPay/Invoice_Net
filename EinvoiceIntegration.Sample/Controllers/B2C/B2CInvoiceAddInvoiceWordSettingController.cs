...
{
    public class B2CInvoiceAddInvoiceWordSettingController : Controller
    {
        // GET: B2CInvoiceAddInvoiceWordSetting
        ...
        public ActionResult Index(AddInvoiceWordSettingModel model)
        {
            var _service = new B2CInvoiceService
            {
                ...
                B2CEnum = Enum.B2C.B2CInvoiceMethod.AddInvoiceWordSetting,
