...
{
    public class B2CInvoiceGetGovInvoiceWordSettingController : Controller
    {
        // GET: B2CInvoiceGetGovInvoiceWordSetting
        ...
        public ActionResult Index(GetGovInvoiceWordSettingModel model)
        {
            var _service = new B2CInvoiceService
            {
                ...
                B2CEnum = Enum.B2C.B2CInvoiceMethod.GetGovInvoiceWordSetting,
